...
function show_emby() {
  ...
  <iframe src="https://xxx.xxx" allow="fullscreen" frameborder="0" style="width: 100%; height: calc(100vh - 115px);"></iframe>
  </div></div>`
  );
}
...
function show_tmdb() {
  $('#page_content').empty().append(`<div class="page-body"><div class="container-xl">
  <iframe src="https://www.themoviedb.org/" frameborder="0" style="width: 100%; height: calc(100vh - 115px);"></iframe>
  </div></div>`
  );
}
